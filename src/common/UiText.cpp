...
const KeyEntry kEntries[] = {
    {UiTextId::WindowTitle, "window.title", L"Krkr Speed Controller"},
    {UiTextId::LabelProcess, "label.process", L"Process"},
    {UiTextId::ButtonHook, "button.hook", L"Hook"},
    {UiTextId::ButtonHooked, "button.hooked", L"Hooked"},
    {UiTextId::LabelGamePath, "label.game_path", L"Game Path"},
    {UiTextId::ButtonLaunchHook, "button.launch_hook", L"Launch + Hook"},
